...
- Blocker list: `docs/release/Release_Blocker_List.md` and `ReleaseRegressionMatrix.md` must list release blockers.
...
- Real game validation record: dry-run and soft-apply observations must follow `RealGameValidationRunbook.md` before an RC tag is proposed.
