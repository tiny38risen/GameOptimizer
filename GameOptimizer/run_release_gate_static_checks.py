...
REQUIRED_MAIN_PATTERNS = [
    ...
    ("StartupPipeline.cpp", r"buildCoreRuntimeComponents\s*\(", "StartupPipeline core runtime component helper missing"),
    ("StartupPipeline.cpp", r"applyStartupMutations\s*\(", "StartupPipeline startup mutation helper missing"),
    ("StartupPipeline.cpp", r"buildRuntimeServices\s*\(", "StartupPipeline runtime service assembly helper missing"),
    ("StartupPipeline.cpp", r"startRuntimeSensors\s*\(", "StartupPipeline runtime sensor start helper missing"),
...
def check_apply_guard_transaction_patterns() -> list[str]:
    ...
    required_patterns = [
        ...
        (scheduler_text, r"NoSideEffectDiscardAllowed", "SchedulerController affinity no-side-effect discard disposition must be explicit"),
...
def check_rc_gate_contract() -> list[str]:
    ...
    required_markers = [
        ...
        "evidence bundle generation failed",
        "verify-rc failed",
        "[PASS] RC gate passed",
        "[FAIL] RC gate failed",
    ]
...
def check_release_evidence_contract() -> list[str]:
    ...
    required_evidence_markers = [
        ...
        "REQUIRED_SOAK_STEPS",
        "soak_report_has_required_steps",
    ...
    required_selftest_markers = [
        ...
        "assert_apply_guard_rollback_failure_is_blocked",
        "assert_apply_guard_rollback_failure_without_transfer_is_blocked",
        ...
        "assert_shutdown_reason_and_soft_apply_baseline_are_recorded",
        "Rollback preserved state count: 0",
        "soft_apply_baseline_summary",
        "not_stored_as_rollback_state_count",
        "assert_affinity_no_side_effect_discard_is_not_blocked",
        "affinity no-side-effect discard became a BLOCKER",
        "assert_partial_soak_report_is_not_selected_for_verify_rc",
        "partial standalone soak report was selected for verify-rc",
