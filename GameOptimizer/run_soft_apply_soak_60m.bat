...
rem Validates: 60 minute completion, clean shutdown, shutdown_reason,
rem runtime_validation_status, rollback_preserved_state_count, BLOCKER count,
rem timeline monotonicity, heartbeat progression, SetThread* calls blocked,
rem OpenThread validation path, and SoftApply baseline INFO evidence.
set TARGET=%~1
set SCRIPT_DIR=%~dp0
