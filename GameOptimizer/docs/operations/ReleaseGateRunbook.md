...
- Blocker list: `docs/release/Release_Blocker_List.md` and `docs/operations/ReleaseRegressionMatrix.md` must list release blockers.
...
- Real game validation record: dry-run and soft-apply observations must follow `docs/operations/RealGameValidationRunbook.md` before an RC tag is proposed.
